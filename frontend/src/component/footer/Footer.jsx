        ...
        <footer className={styles.footer}>
            <div className={styles.container}>
                ...
                <div className={styles.section}>
                    ...
                    <p>👨‍💻 <strong>Developed by: Alok Kumar</strong></p>
                    
                    <div className={styles.socialIcons}>
                        <a 
                            href="https://github.com/alokkumar59" 
                            target="_blank" 
                        ...
                        <a 
                            href="https://www.linkedin.com/in/alokkumar866713" 
                        ...
                        <a 
                            href="https://twitter.com/Alok_0001" 
                            target="_blank" 
                            rel="noopener noreferrer"
                        >
                ...
                <div className={styles.section}>
                    ...
                    <ul>
                        ...
                        <li><Link to="https://github.com/alokkumar59">GitHub Repository</Link></li>
            ...
            <div className={styles.copyright}>
                <p>© 2025 Voting Survey. All rights reserved. | MIT License</p>
                <p>
                    📧 Contact: 
                    <a href="mailto:studentalokkumar1278@gmail.com">
                        <FontAwesomeIcon icon={faEnvelope} className={styles.icon} /> studentalokkumar1278@gmail.com
                    </a>
                </p>
            </div>
        </footer>
